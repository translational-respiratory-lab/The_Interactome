...
![equation](http://latex.codecogs.com/gif.latex?%5Cdpi%7B110%7D%20%5Ctext%7BDifferntial%20score%20%7D(a,b)%20=%20max_%7Bi%7D(e%5E%7Bi%7D_%7Ba,b%7D)-min_%7Bi%7D(e%5E%7Bi%7D_%7Ba,b%7D))
...
Rscript NMDS_wSNF.R 
```
We pre-process the dataset to remove microbes that are not present in atleast 5% of the samples. We first implement wSNF, say ![equation](http://latex.codecogs.com/gif.latex?%5Cdpi%7B110%7D%20W_%7Bt%7D) is the integrated similarity matrices of patients. We then implement NMDS using ![equation](http://latex.codecogs.com/gif.latex?%5Cdpi%7B110%7D%200.5-W_%7Bt%7D) as the disimilarity index, since 0.5 is the maximum value the integrated similarity matrix can take.
