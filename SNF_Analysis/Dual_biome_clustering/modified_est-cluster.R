...
discretisation<-function (eigenVectors) 
{
  ...
  eigenVectors[is.na(eigenVectors)]<-0 #Added this line, as NA values affect SVD
  eigenVectors[is.infinite(eigenVectors)]<-0 #Added this line, as INF values affect SVD
  n = nrow(eigenVectors)
  k = ncol(eigenVectors)
  R = matrix(0, k, k)
