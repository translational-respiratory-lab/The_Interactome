...
if (clusters[count]==3){
  dif<-list()
  sink(paste(nam,"_Dunn-test.txt",sep=''))
  for (i in 1:80){
...
#For viruses remove the 1 patient in cluster 3
#Factor the x column and change level to 1,2
#Run the two cluster evaluvation